...
>
> **Validating HEAD:** OpenClaw catalog port batches 1-5 in-flight on
...
> batches 1-5 add ~320 tests across foundation utilities, safety
> extensions, agent-loop extensions, compaction + edit recovery, and
> activation planner + hierarchical sandbox policy. Continuing the
> OpenClaw port across subsequent batches; see
