...
>
> **Validating HEAD:** bridge-e2e subprocess-reap flake fix --
> cherry-picked from `claude/wonderful-sutherland-2159f9` (`7592687`)
> on top of the deferred-primitive wiring pass + catalog 10 (this
> branch `claude/stoic-banach-74402b`, pushed to `origin/main`).
