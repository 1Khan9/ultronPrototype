...
│       │   ├── voice.py              ← Phase 8 voice handlers (handle_app_launch / handle_screen_context_query) bridging RoutingIntent -> native primitives
