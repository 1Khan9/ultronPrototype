...
**2026-05-22 session C: OPEN_LAST_SOURCE + news-multi-event + SearxNG hardening + GateDecision scoping fix -- COMPLETE.** Tests **3946 passing / 16 skipped / 0 failed in ~75 s** (+1 net for the new routing test). One commit on top of `c9e85e9`.
