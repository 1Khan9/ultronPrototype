...
|---|---|---|---|
| `addressing.warm_mode_duration_seconds` | 10 | **30** | User override per [feedback_ultron_extension.md](C:\Users\alecf\.claude\projects\C--STC-ultronPrototype\memory\feedback_ultron_extension.md) |
| `llm.provider` | `"ollama"` | **`"llama_cpp"`** | Compat-test outcome [feedback_llm_runtime_decision.md](C:\Users\alecf\.claude\projects\C--STC-ultronPrototype\memory\feedback_llm_runtime_decision.md) |
...
| (NEW for Phase 3) | "llama_cpp" | n/a | `llm.provider` — non-Ollama; pinned per [feedback_llm_runtime_decision.md](C:\Users\alecf\.claude\projects\C--STC-ultronPrototype\memory\feedback_llm_runtime_decision.md) |
