...
def test_default_preset_is_8b_iq3xs() -> None:
    ...
    assert cfg.n_ctx == 3072  # 2026-06-24: 8B-iq3xs preset n_ctx trimmed 4096->3072 (VRAM)
...
"""
    ...
    assert cfg.llm.n_ctx == 3072  # 2026-06-24: 8B-iq3xs preset n_ctx trimmed 4096->3072 (VRAM)
