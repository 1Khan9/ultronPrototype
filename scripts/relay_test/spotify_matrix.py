...
CASES = [
    ...
    # --- volume delta (relative "by N%") ---
    ("lower the volume by 10%", "volume_down", None),
    ("raise the volume by 20", "volume_up", None),
    ("turn it up by 15%", "volume_up", None),
    ("turn the volume down by 10 percent", "volume_down", None),
    ("increase the volume by 5", "volume_up", None),
    ("decrease volume by 10%", "volume_down", None),
    ("bump it up by 10", "volume_up", None),
    ("drop the volume by 20%", "volume_down", None),
    ("volume up by 15", "volume_up", None),
    ("volume down by 10", "volume_down", None),
    ("lower it by 25 percent", "volume_down", None),
    ("raise it by 10", "volume_up", None),
    # --- volume up ---
