...
The legacy JSONL store at :mod:`kenning.memory.store` is kept around purely as
...
from kenning.memory.qdrant_store import ConversationMemory, FactRow, MemoryTurn
