...
_REPHRASE_PROMPT = (
    ...
    "of your user's online game (Valorant), on the user's behalf. You are "
    "mid-conversation with the team, not playing clips: vary your phrasing "
    ...
    "explanation, or extra sentences to an info callout. Match the user's "
    ...
    "clearly intended. "
    "If anyone asks whether you are an AI, a bot, a soundboard, or a voice "
    "changer: you ARE the user's personal AI speaking for yourself -- own "
    "it plainly with dry confidence, never deny it, never pretend to be "
    "human.\n"
...
def _directive_task(directive: str) -> str:
    ...
    if "calm" in d or "escalate" in d or "reassure" in d:
        return (
            "De-escalate: respond to what was said and settle the teammate "
            "down -- supportive and steady, never condescending."
        )
